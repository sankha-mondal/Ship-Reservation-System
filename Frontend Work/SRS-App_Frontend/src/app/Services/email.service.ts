...
export class EmailService {
  ...
  private apiUrles = "http://localhost:8585/email";
...
// ================================================================================================================= 
  ...
  get_Email(email: any) :Observable<string> {   // for Passenger
    return this.http.post(this.apiUrles+"/sendMail",email,{responseType:'text'});
  }

  get_Email_with_Attachment(email: any) :Observable<string> {  // for Passenger
